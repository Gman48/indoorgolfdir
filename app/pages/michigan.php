...
<div id="hero-bg" class="hero-bg-state">
    ...
    <h1 class="headline state-name-lg">Michigan</h1>
...
<div class="container">
    <p class="state-summary">With over 100 indoor golf facilities in Michigan you are sure to find one that meets your needs.  Search by clicking on a region above or check out our featured Michigan facilities below.</p>
</div>
