...
<div id="hero-bg" class="hero-bg-state">
    ...
    <h1 class="headline">Texas</h1>
    <h3 class="sub-text">What region of Texas are you looking in?</h3>

    <div class="region-btns">
        <a href="<?=ROOT?>/dynamic_region?region_id=81" class="region-btn">Dallas-Fort Worth</a>
        <a href="<?=ROOT?>/dynamic_region?region_id=82" class="region-btn">Houston</a>
        <a href="<?=ROOT?>/dynamic_region?region_id=83" class="region-btn">Austin</a>
        <a href="<?=ROOT?>/dynamic_region?region_id=84" class="region-btn">San Antonio</a>
        <a href="<?=ROOT?>/dynamic_region?region_id=85" class="region-btn">Other (rural TX)</a>
    </div>
</div>

<div class="container">
    <p class="state-summary">Texas is home to over 100 indoor golf facilities with golf simulators that let you enjoy the game year round. Search by clicking on a region above or check out our featured Texas facilities below.</p>
</div>
