...
<div id="hero-bg" class="hero-bg-state">
    ...
    <h1 class="headline-state">Massachusetts</h1>
...
<div class="container">
    <p class="state-instructions">With over 50 indoor golf facilities in Massachusetts you are sure to find one that meets your needs.  Search by clicking on a region above or check out our featured Massachusetts facilities below.</p>
</div>
