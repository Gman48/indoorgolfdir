...
<div id="ont-sw-bg">
    <div class="container">
        <div class="hero">
            ...
            <h1 class="headline-region region-name">Southwestern Ontario</h1>
            <p class="listings-title">The following is a listing of indoor golf facilities that can be found in Southwestern Ontario.  Each listing has a brief description of the facility, it's amenities and a link to the facilities website. Click on the facility name for more detailed information about the facility, including reviews.</p>
        </div>
    </div>
</div>
...
<section class="container">
    <div class="listings-grid">
        <div class="listings-grid-col1">
            ...
            <?php 
                $query = "select * from allfacilities where region = 'ont_southwest' order by featured desc, rand()";
                $rows = db_query($query);
            ?>
