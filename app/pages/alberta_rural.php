...
<!-- Hero Section -->
<div id="region-hero">
    <img src="<?=ROOT?>/assets/images/ab_rural.jpg" alt="Alberta Rural Image">
</div>

<div class="container region-container">
    <div >
        <h1 class="headline-region">Indoor Golf Facilities</h1>
        <h1 class="headline-region region-name">Rural Alberta</h1>
        <p class="listings-title">The following is a listing of indoor golf facilities that can be found outside of the major Alberta centers.  Each listing has a brief description of the facility, it's amenities and a link to the facilities website. Click on the facility name for more detailed information about the facility, including reviews.</p>
    </div>
</div>
...
<section class="container">
    <div class="listings-grid">
        <div class="listings-grid-col1">
            ...
            <?php 
                $query = "select * from allfacilities where region = 'ab_other' order by featured desc, rand()";
                $rows = db_query($query);
            ?>
