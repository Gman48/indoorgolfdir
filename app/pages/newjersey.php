...
<div id="hero-bg" class="hero-bg-state">
    ...
    <h1 class="headline-state">New Jersey</h1>
...
<div class="container">
    <p class="state-instructions">With over 100 indoor golf facilities in New York State you are sure to find one that meets your needs.  Search by clicking on a region above or check out our featured New York State facilities below.</p>
</div>
