...
<head>
    ...
    <title>Indoor golf simulators near me - <?=ucfirst($region_pagename)?></title>
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PPZ3S79D8G"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-PPZ3S79D8G');
</script>
