...
<div id="hero-bg" class="hero-bg-state">
    ...
    <h1 class="headline">Ohio</h1>
    <h3 class="sub-text">What region of Ohio are you looking in?</h3>
...
<div class="container">
    <p class="state-summary">Ohio is home to over 90 indoor golf facilities with golf simulators that let you enjoy the game year round. Search by clicking on a region above or check out our featured Ohio facilities below.</p>
</div>
