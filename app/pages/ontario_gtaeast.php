...
<div id="gta-east-bg">
    <div class="container">
        <div class="hero">
            ...
            <h1 class="headline-region region-name">East GTA</h1>
            <p class="listings-title">The following is a listing of indoor golf facilities that can be found in the East GTA area.  Each listing has a brief description of the facility, it's amenities and a link to the facilities website. Click on the facility name for more detailed information about the facility, including reviews.</p>
        </div>
    </div>
</div>
...
<section class="container">
    <div class="listings-grid">
        <div class="listings-grid-col1">
            ...
            <?php 
                $query = "select * from allfacilities where region = 'gta_east' order by featured desc, rand()";
                $rows = db_query($query);
            ?>
